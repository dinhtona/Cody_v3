...
namespace ExcelWebTool.Repositories.Migrations
{
    ...
    [Migration("20220803161243_Default-for-base-entity-update")]
    partial class Defaultforbaseentityupdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExcelWebTool.Repositories.Entities.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ExcelWebTool.Repositories.Entities.Recloser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("ExcelWebTool.Repositories.Entities.RecloserData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("Department", "RecloserId", "Date", "Time")
                        .IsUnique()
            ...
            modelBuilder.Entity("ExcelWebTool.Repositories.Entities.Recloser", b =>
                {
                    b.HasOne("ExcelWebTool.Repositories.Entities.Department", "Department")
                        .WithMany("Reclosers")
            ...
            modelBuilder.Entity("ExcelWebTool.Repositories.Entities.RecloserData", b =>
                {
                    b.HasOne("ExcelWebTool.Repositories.Entities.Recloser", "Recloser")
